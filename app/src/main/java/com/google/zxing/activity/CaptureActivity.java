...
import com.ywt.qrcode_zxing.R;
import com.ywt.qrcode_zxing.util.Constant;
...
public class CaptureActivity extends AppCompatActivity implements Callback {
   ...
   private ImageView flashLightIv_open;//闪光灯
    private ImageView flashLightIv_close;
    private RelativeLayout flashLightIv;
...
//		cancelScanButton = (Button) this.findViewById(R.id.btn_cancel_scan);
        ...
        flashLightIv_open = findViewById(R.id.flashLightIv_open);
        flashLightIv_close = findViewById(R.id.flashLightIv_close);
        ...
        flashLightIv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(CameraManager.get().flashControlHandler()){
                    flashLightIv_close.setVisibility(View.GONE);
                    flashLightIv_open.setVisibility(View.VISIBLE);
                }else {
                    flashLightIv_close.setVisibility(View.VISIBLE);
                    flashLightIv_open.setVisibility(View.GONE);
                }
            }
        });
